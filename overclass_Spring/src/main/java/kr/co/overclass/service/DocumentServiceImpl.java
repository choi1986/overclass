...
public class DocumentServiceImpl implements DocumentService {
	...
	public List<DocumentDTO> myFeed_list(Criteria cri, String user_id) throws Exception {
		List<DocumentDTO> list = dao.myFeed_list(cri, user_id);
	...
	@Override
	public List<DocumentDTO> myFeed_list(Criteria cri, String user_id, String myid) throws Exception {
		List<DocumentDTO> list = dao.myFeed_list(cri, user_id);
